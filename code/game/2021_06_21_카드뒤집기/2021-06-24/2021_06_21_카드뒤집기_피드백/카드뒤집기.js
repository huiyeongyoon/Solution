...
function clickHandler(event) {
    console.log('target', event.target.children);
    console.log('img', event.target.children[0]);

    //event.target.children.setAttribute('style','visibility: visible');
    console.log(event.target.children[0].style.visibility = "visible");
